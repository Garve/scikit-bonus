...
def mean_absolute_deviation(
    ...
    As a formula, this is np.mean(np.abs(y_true - y_pred)).
...
def mean_absolute_percentage_error(
    ...
    As a formula, this is np.mean(np.abs((y_true - y_pred) / y_true)).
...
def symmetric_mean_absolute_percentage_error(
    ...
    As a formula, this is 2 * np.mean(np.abs((y_true - y_pred)) / (np.abs(y_true) + np.abs(y_pred))).
